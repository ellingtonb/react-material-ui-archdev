        ...
        <Grid container direction={"column"}>
            ...
            >
                ...
                <Grid item container justify={matchesMD ? "center" : undefined}>
                    ...
                    <Grid item lg container direction={"column"} alignItems={matchesMD ? "center" : undefined} style={{ marginBottom: matchesMD ? "2.5em" : 0 }}>
                        <Grid item>
                            <img
                                src={yearbook}
                        ...
                        <Grid item>
                            <Typography variant={"caption"}>
                                A page from my Saphomore Yearbook
                            </Typography>
                        </Grid>
                    </Grid>
                    <Hidden mdDown>
                    ...
                    <Grid item lg container direction={"column"} alignItems={matchesMD ? "center" : "flex-end"}>
                        <Grid item>
                            <img
                                src={puppy}
