        ...
        <Grid container direction={"column"}>
            ...
            <Grid item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}
                ...
                <Grid item container direction={"column"} alignItems={matchesMD ? "center" : undefined} lg>
                    <Grid item>
                        <Typography align={matchesMD ? "center" : undefined} variant={"h4"} gutterBottom style={{ color: '#000000', marginTop: "3em" }}>
                            Consultation
                        </Typography>
                    </Grid>
                    <Grid item>
                        <Typography align={matchesMD ? "center" : undefined} variant={"body2"} style={{ color: '#FFFFFF', maxWidth: '20em' }} paragraph>
                ...
                <Grid item lg style={{ alignSelf: "center" }}>
                    <img src={consultation} alt={"Handshake"} width={"100%"} style={{ maxWidth: 1000, marginTop: matchesMD ? "5em" : undefined }} />
                </Grid>
            </Grid>
            <Grid item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}
                  style={{ backgroundColor: '#FF7373', height: '80em' }}>
                <Grid item container direction={"column"} alignItems={matchesMD ? "center" : undefined} lg>
                    <Grid item>
                        <Typography align={matchesMD ? "center" : undefined} variant={"h4"} gutterBottom style={{ color: '#000000', marginTop: "3em" }}>
                            Mockup
                ...
                <Grid item lg style={{ alignSelf: "center" }}>
                    <img src={mockup} alt={"Basic Website Design Outline"} width={"100%"} style={{ maxWidth: matchesMD ? 600 : 1000, marginTop: matchesMD ? "5em" : undefined }} />
                </Grid>
            </Grid>
            <Grid item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}
                  style={{ backgroundColor: '#39B54A', height: '80em' }}>
                <Grid item container direction={"column"} alignItems={matchesMD ? "center" : undefined} lg>
                    <Grid item>
                        <Typography align={matchesMD ? "center" : undefined} variant={"h4"} gutterBottom style={{ color: '#000000', marginTop: "3em" }}>
                            Review
                ...
                <Grid item lg style={{ alignSelf: "center" }}>
                    <img src={review} alt={"Magnifying Glass"} width={"100%"} style={{ maxWidth: matchesMD ? 400 : 1000, marginTop: matchesMD ? "5em" : undefined }} />
                </Grid>
            </Grid>
            <Grid item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}
                  style={{ backgroundColor: '#A67C52', height: '80em' }}>
                <Grid item container direction={"column"} alignItems={matchesMD ? "center" : undefined} lg>
                    <Grid item>
                        <Typography align={matchesMD ? "center" : undefined} variant={"h4"} gutterBottom style={{ color: '#000000', marginTop: "3em" }}>
                            Design
                ...
                <Grid item lg style={{ alignSelf: "center" }}>
                    <img src={design} alt={"Paintbrush Leaving Stroke of Paint"} width={"100%"} style={{ maxWidth: matchesMD ? 600 : 1000, marginTop: matchesMD ? "5em" : undefined }} />
                </Grid>
            </Grid>
            <Grid item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}
                  style={{ backgroundColor: '#39B54A', height: '80em' }}>
            ...
            <Grid item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}
                ...
                <Grid item lg style={{ alignSelf: "center" }}>
                    <img src={build} alt={"Construction Site"} width={"100%"} style={{ maxWidth: matchesMD ? 500 : 1000, marginTop: matchesMD ? "5em" : undefined }} />
                </Grid>
            </Grid>
            <Grid item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}
                  style={{ backgroundColor: '#C1272D', height: '80em' }}>
                <Grid item container direction={"column"} alignItems={matchesMD ? "center" : undefined} lg>
                    <Grid item>
                        <Typography align={matchesMD ? "center" : undefined} variant={"h4"} gutterBottom style={{ color: '#000000', marginTop: "3em" }}>
                            Launch
                ...
                <Grid item lg style={{ alignSelf: "center" }}>
                    <img src={launch} alt={"Rocket"} width={"100%"} style={{ maxWidth: 1000, maxHeight: matchesMD ? 600 : 1000, marginTop: matchesMD ? "5em" : undefined }} />
                </Grid>
            </Grid>
            <Grid item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}
                  style={{ backgroundColor: '#8E45CE', height: '80em' }}>
                <Grid item container direction={"column"} alignItems={matchesMD ? "center" : undefined} lg>
                    <Grid item>
                        <Typography align={matchesMD ? "center" : undefined} variant={"h4"} gutterBottom style={{ color: '#000000', marginTop: "3em" }}>
                            Maintain
                ...
                <Grid item lg style={{ alignSelf: "center" }}>
                    <img src={maintain} alt={"Wrench Tightening Bolts"} width={"100%"} style={{ maxWidth: 1000, maxHeight: matchesMD ? 600 : 1000, marginTop: matchesMD ? "5em" : undefined }} />
                </Grid>
            </Grid>
            <Grid item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}
                  style={{ backgroundColor: '#29ABE2', height: '80em' }}>
                <Grid item container direction={"column"} alignItems={matchesMD ? "center" : undefined} lg>
                    <Grid item>
                        <Typography align={matchesMD ? "center" : undefined} variant={"h4"} gutterBottom style={{ color: '#000000', marginTop: "3em" }}>
                            Iterate
                ...
                <Grid item lg style={{ alignSelf: "center" }}>
                    <img src={iterate} alt={"Falling Dominoes"} width={"100%"} style={{ maxWidth: matchesMD ? 500 : 1000, marginTop: matchesMD ? "5em" : undefined }} />
                </Grid>
            </Grid>
            <Grid item>
                <CallToAction
